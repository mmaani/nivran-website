...
\restrict EY9vzoEhmsGdwCgMKBPazkYlQBPk9NwHpqC58vPrPgHSnSdVVyfFwhiuaq1egM8
...
--
-- Name: customer_email_verification_codes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.customer_email_verification_codes (
    id bigint NOT NULL,
    customer_id bigint NOT NULL,
    code text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
--
-- Name: customer_email_verification_codes_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.customer_email_verification_codes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: customer_email_verification_codes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.customer_email_verification_codes_id_seq OWNED BY public.customer_email_verification_codes.id;
...
--
-- Name: order_refunds_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: order_refunds_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
CREATE TABLE public.orders (
    ...
    promo_consumed boolean DEFAULT false NOT NULL,
    promo_consumed_at timestamp with time zone,
    promo_consume_failed boolean DEFAULT false NOT NULL,
    promo_consume_error text,
    inventory_committed_at timestamp with time zone,
    refunded_jod numeric DEFAULT 0,
...
CREATE TABLE public.refunds (
    ...
    last_error text,
    payload jsonb,
    CONSTRAINT refunds_amount_jod_check CHECK ((amount_jod > (0)::numeric)),
    CONSTRAINT refunds_method_check CHECK ((method = ANY (ARRAY['PAYTABS'::text, 'MANUAL'::text]))),
...
--
-- Name: restock_jobs; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.restock_jobs (
    id bigint NOT NULL,
    order_id bigint NOT NULL,
    ...
    CONSTRAINT restock_jobs_status_check CHECK ((status = ANY (ARRAY['SCHEDULED'::text, 'DONE'::text, 'CANCELED'::text, 'FAILED'::text])))
);


--
-- Name: restock_jobs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.restock_jobs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: restock_jobs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.restock_jobs_id_seq OWNED BY public.restock_jobs.id;


--
-- Name: sales_audit_logs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: sales_audit_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.sales_audit_logs_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: sales_audit_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.sales_audit_logs_id_seq OWNED BY public.sales_audit_logs.id;
...
--
-- Name: staff_login_attempts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: staff_login_attempts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.staff_login_attempts_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: staff_login_attempts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.staff_login_attempts_id_seq OWNED BY public.staff_login_attempts.id;
...
CREATE TABLE public.staff_users (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT staff_users_role_check CHECK ((role = ANY (ARRAY['admin'::text, 'ops'::text, 'sales'::text, 'staff'::text])))
);
...
--
-- Name: customer_email_verification_codes id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_email_verification_codes ALTER COLUMN id SET DEFAULT nextval('public.customer_email_verification_codes_id_seq'::regclass);
...
--
-- Name: order_refunds id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: restock_jobs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.restock_jobs ALTER COLUMN id SET DEFAULT nextval('public.restock_jobs_id_seq'::regclass);


--
-- Name: sales_audit_logs id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sales_audit_logs ALTER COLUMN id SET DEFAULT nextval('public.sales_audit_logs_id_seq'::regclass);
...
--
-- Name: staff_login_attempts id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staff_login_attempts ALTER COLUMN id SET DEFAULT nextval('public.staff_login_attempts_id_seq'::regclass);
...
--
-- Name: customer_email_verification_codes customer_email_verification_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_email_verification_codes
    ADD CONSTRAINT customer_email_verification_codes_pkey PRIMARY KEY (id);
...
--
-- Name: restock_jobs restock_jobs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.restock_jobs
    ADD CONSTRAINT restock_jobs_pkey PRIMARY KEY (id);


--
-- Name: sales_audit_logs sales_audit_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sales_audit_logs
    ADD CONSTRAINT sales_audit_logs_pkey PRIMARY KEY (id);
...
--
-- Name: staff_login_attempts staff_login_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.staff_login_attempts
    ADD CONSTRAINT staff_login_attempts_pkey PRIMARY KEY (id);
...
--
-- Name: auth_rate_limits_key_action_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX auth_rate_limits_key_action_idx ON public.auth_rate_limits USING btree (key, action, created_at DESC);
...
--
-- Name: customer_email_verification_codes_code_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_email_verification_codes_code_idx ON public.customer_email_verification_codes USING btree (code);


--
-- Name: customer_email_verification_codes_customer_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_email_verification_codes_customer_idx ON public.customer_email_verification_codes USING btree (customer_id);


--
-- Name: customer_email_verification_codes_expires_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_email_verification_codes_expires_idx ON public.customer_email_verification_codes USING btree (expires_at);


--
-- Name: customer_password_reset_tokens_customer_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_password_reset_tokens_customer_id_idx ON public.customer_password_reset_tokens USING btree (customer_id);


--
-- Name: customer_password_reset_tokens_customer_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_password_reset_tokens_customer_idx ON public.customer_password_reset_tokens USING btree (customer_id);


--
-- Name: customer_password_reset_tokens_expires_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_password_reset_tokens_expires_idx ON public.customer_password_reset_tokens USING btree (expires_at);


--
-- Name: customer_password_reset_tokens_token_hash_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_password_reset_tokens_token_hash_idx ON public.customer_password_reset_tokens USING btree (token_hash);


--
-- Name: customer_password_reset_tokens_token_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX customer_password_reset_tokens_token_idx ON public.customer_password_reset_tokens USING btree (token);
...
--
-- Name: email_send_log_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX email_send_log_created_at_idx ON public.email_send_log USING btree (created_at DESC);


--
-- Name: email_send_log_kind_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX email_send_log_kind_idx ON public.email_send_log USING btree (kind);


--
-- Name: email_send_log_to_email_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX email_send_log_to_email_idx ON public.email_send_log USING btree (to_email);


--
-- Name: email_send_logs_created_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX email_send_logs_created_at_idx ON public.email_send_logs USING btree (created_at DESC);


--
-- Name: email_send_logs_kind_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX email_send_logs_kind_idx ON public.email_send_logs USING btree (kind);


--
-- Name: email_send_logs_to_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX email_send_logs_to_idx ON public.email_send_logs USING btree ("to");
...
--
-- Name: idx_orders_inventory_committed_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_orders_inventory_committed_at ON public.orders USING btree (inventory_committed_at);
...
--
-- Name: idx_orders_promo_consume_failed; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_orders_promo_consume_failed ON public.orders USING btree (promo_consume_failed);


--
-- Name: idx_orders_promo_consumed; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_orders_promo_consumed ON public.orders USING btree (promo_consumed);
...
--
-- Name: idx_sales_audit_logs_action_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_audit_logs_action_time ON public.sales_audit_logs USING btree (action, created_at DESC);


--
-- Name: idx_sales_audit_logs_actor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_audit_logs_actor ON public.sales_audit_logs USING btree (actor_staff_id, created_at DESC);


--
-- Name: idx_sales_audit_logs_actor_action_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_audit_logs_actor_action_time ON public.sales_audit_logs USING btree (actor_staff_id, action, created_at DESC);


--
-- Name: idx_sales_audit_logs_actor_staff_id_created_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_audit_logs_actor_staff_id_created_at ON public.sales_audit_logs USING btree (actor_staff_id, created_at DESC);


--
-- Name: idx_sales_audit_logs_order; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_audit_logs_order ON public.sales_audit_logs USING btree (order_id);


--
-- Name: idx_sales_audit_logs_order_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_sales_audit_logs_order_id ON public.sales_audit_logs USING btree (order_id);


--
-- Name: idx_staff_login_attempts_user_success_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_staff_login_attempts_user_success_time ON public.staff_login_attempts USING btree (username, success, attempted_at DESC);


--
-- Name: idx_staff_login_attempts_username_attempted_at; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_staff_login_attempts_username_attempted_at ON public.staff_login_attempts USING btree (username, attempted_at DESC);


--
-- Name: idx_staff_login_attempts_username_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_staff_login_attempts_username_time ON public.staff_login_attempts USING btree (username, attempted_at DESC);
...
--
-- Name: idx_staff_users_role; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_staff_users_role ON public.staff_users USING btree (role);


--
-- Name: idx_staff_users_role_active; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_staff_users_role_active ON public.staff_users USING btree (role, is_active, updated_at DESC);


--
-- Name: order_refunds_idem_uq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX order_refunds_idem_uq ON public.order_refunds USING btree (order_id, idempotency_key);
...
--
-- Name: orders_customer_gin_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX orders_customer_gin_idx ON public.orders USING gin (customer);


--
-- Name: orders_inventory_commit_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX orders_inventory_commit_idx ON public.orders USING btree (inventory_committed_at);
...
--
-- Name: refunds_idempotency_key_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX refunds_idempotency_key_idx ON public.refunds USING btree (idempotency_key);


--
-- Name: refunds_order_id_idem_key_ux; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX refunds_order_id_idem_key_ux ON public.refunds USING btree (order_id, idempotency_key);
...
--
-- Name: restock_jobs_refund_id_ux; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX restock_jobs_refund_id_ux ON public.restock_jobs USING btree (refund_id);


--
-- Name: restock_jobs_run_at_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX restock_jobs_run_at_idx ON public.restock_jobs USING btree (status, run_at);
...
--
-- Name: ux_paytabs_callbacks_tran_ref; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX ux_paytabs_callbacks_tran_ref ON public.paytabs_callbacks USING btree (tran_ref) WHERE (tran_ref IS NOT NULL);
...
--
-- Name: customer_email_verification_codes customer_email_verification_codes_customer_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.customer_email_verification_codes
    ADD CONSTRAINT customer_email_verification_codes_customer_id_fkey FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE CASCADE;
...
--
-- Name: order_items order_items_order_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.order_items
    ADD CONSTRAINT order_items_order_id_fk FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;
...
--
-- Name: orders orders_customer_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_customer_id_fk FOREIGN KEY (customer_id) REFERENCES public.customers(id) ON DELETE SET NULL;
...
--
-- Name: refunds refunds_order_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.refunds
    ADD CONSTRAINT refunds_order_fk FOREIGN KEY (order_id) REFERENCES public.orders(id);
...
--
-- Name: restock_jobs restock_jobs_order_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.restock_jobs
    ADD CONSTRAINT restock_jobs_order_id_fkey FOREIGN KEY (order_id) REFERENCES public.orders(id) ON DELETE CASCADE;


--
-- Name: restock_jobs restock_jobs_refund_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.restock_jobs
    ADD CONSTRAINT restock_jobs_refund_fk FOREIGN KEY (refund_id) REFERENCES public.refunds(id);


--
-- Name: restock_jobs restock_jobs_refund_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.restock_jobs
    ADD CONSTRAINT restock_jobs_refund_id_fkey FOREIGN KEY (refund_id) REFERENCES public.refunds(id) ON DELETE CASCADE;
...
\unrestrict EY9vzoEhmsGdwCgMKBPazkYlQBPk9NwHpqC58vPrPgHSnSdVVyfFwhiuaq1egM8
