  ...
  return (
    <div style={{ maxWidth: 560, margin: "24px auto" }} className="panel">
      ...
      <form onSubmit={onSubmit} style={{ display: "grid", gap: 8 }}>
        <input className="input" name="password" type="password" minLength={8} required placeholder={isAr ? "كلمة المرور الجديدة" : "New password"} />
        <input className="input" name="confirm" type="password" minLength={8} required placeholder={isAr ? "تأكيد كلمة المرور" : "Confirm password"} />
